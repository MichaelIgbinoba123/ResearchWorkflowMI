...
# read the file
path_file = 'D:\wrfout_d01_2022-09-24_00_00_00'
...
for i in range(num_time_indices):
    ...
    ax.streamplot(lons[::y_stride, ::x_stride], lats[::y_stride, ::x_stride],
                  ...
                  linewidth=1.0, density=1.5, arrowsize=1.0, color='white', transform=ccrs.PlateCarree())
...
# Multiply the average shear by 1.944 to convert it to knots
    ...
    ax.text(0.05, 0.95, f'Average 200-850mb shear = {avg_shear_knots:.2f} kts', transform=ax.transAxes,
    ...
    ax.quiver(lon_min + 13, lat_min + 1, arrow_dx, arrow_dy, angles='xy', scale_units='xy', scale=4,
    ...
    plt.title('Composite Reflectivity + 200-850mb Wind Shear')
