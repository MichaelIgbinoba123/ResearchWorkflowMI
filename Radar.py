...
for i in range(num_time_indices):
	...
	p_levels = [925 - delta_pressure_mb_per_degree * dist_deg * 85 for dist_deg in radar_distance_deg]
	...
	cmap2 = colortables.get_colortable('Carbone42')
	...
	# Find the maximum and minimum velocity values, excluding NaN pixels
	...
	for ax in [ax1, ax2]:
	    ax.plot(radar_lon, radar_lat, marker='*', color='gold', markersize=20,
